...
const {umod, bitLength, modPow} = BigMath;
...
class CombMixin {
  ...
  powgh(e1, e2) {
    // return umod(modPow(this.g, e1, this.n) * modPow(this.h, e2, this.n), this.n);
...
class WnafMixin extends CombMixin {
  ...
  pow2(b1, b1Inv, e1, b2, b2Inv, e2) {
    ...
    // return umod(modPow(b1, e1, this.n) * modPow(b2, e2, this.n), this.n);
