...
class Goo {
  ...
  powWNAF(b, bi, e) {
    ...
    const wnaf0 = this.wnaf(e, ws, this.wnaf1, bits);
  ...
  pow2(b1, b1i, e1, b2, b2i, e2) {
    ...
    const wnaf1 = this.wnaf(e1, ws, this.wnaf1, bits);
    const wnaf2 = this.wnaf(e2, ws, this.wnaf2, bits);
